...
public class ButonScadere implements ActionListener {
    private final JTextField textField1, textField2;
    private final JLabel label;

    public ButonScadere(JLabel l, JTextField t1, JTextField t2) {
        this.label=l;
        this.textField1=t1;
        this.textField2=t2;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Map<Integer, Integer> polinom3=scadere.scadere(polinom1,polinom2);
