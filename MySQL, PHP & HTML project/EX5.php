<html>
	...
	<a href = "http://localhost/proiect/Ex5_a.php">
		<p style = "font-family:impact; color:black; font-size:20px">a) Să se găsească numele, descrierea și timpul de preparare pentru rețetele non-vegetariene, care au timpul de preparare maxim.</p>
	</a>
	<a href = "http://localhost/proiect/Ex5_b.php">
		<p style = "font-family:impact; color:black; font-size:20px">b) Să se găsească detaliile rețetelor care folosesc cel puțin un ingredient folosit la rețeta cu numele ’Sărmăluțe moldovenești’.</p>
	</a>
	</td>
	</tr>
	</table>
