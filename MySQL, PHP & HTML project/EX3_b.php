<html>
	...
	<table width="150px" border="1px">
	<tr>
	<td width = "20px" style="background-color:aa58d6; text-align:center;">Nr. crt</td>
	<td style="background-color:aa58d6; text-align:center;">Ingredient</td>
	</tr>
	
	<tr>
	<td style = "text-align:center;"> 
	<?php
	function interogare3_b1(){
		...
		if(isset($_POST['s'])){
			...
			$sql = "SELECT ingredient
					FROM ingredient
					WHERE LOWER(ingredient) LIKE '_$valoare%';";
			}
