<html>
	...
	<a href = "http://localhost/proiect/Ex6_a.php">
		<p style = "font-family:impact; color:black; font-size:20px">a) Să se găsească timpul de preparare minim, mediu și maxim pentru fiecare categorie de rețetă</p>
	</a>
	<a href = "http://localhost/proiect/Ex6_b.php">
		<p style = "font-family:impact; color:black; font-size:20px">b) Să se găsească cantitatea totală folosită pentru ingredientul ’usturoi’ în rețete din categoria ’tocană’ în funcție de unitatea de măsură.</p>
	</a>
	</td>
	</tr>
	</table>
